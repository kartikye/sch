...
#create users
db.execute('create table if not exists Users (user_id integer primary key autoincrement, first_name text, last_name text, msg_id text, email text, password text, calendar text, other_calendars text, timezone text)')
...
#create homework
db.execute('create table if not exists Tasks (id integer primary key autoincrement, userid integer, subject_id integer, name text, due datetime, time_left integer)')
